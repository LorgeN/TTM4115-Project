...
class Facilitator(MachineBase):
    ...
    def get_definiton(self) -> Tuple[List[State], List[Transition]]:
        ...
        s_helping = State(name="s_helping", events={
            "system_new_request_received": "notify_new_request(*)",
            "system_request_accepted": "notify_request_accepted(*)",
            "system_request_completed": "notify_request_completed(*)",
            "message_request_status": "send_status"
        ...
        t1 = Transition("s_initial", "s_helping",
                        trigger="message_request_accept", action="request_accept(*)")
        t2 = Transition("s_helping", "s_initial",
                        trigger="message_request_completed", action="request_complete(*)")
    ...
    def send_status(self) -> None:
        self.handle.publish(MQTTMessage(event="message_status", data={
            "busy": self.busy
        }))
    ...
    def request_accept(self, *args, **kwargs) -> None:
        ...
        self.send_global_event("system_request_accepted",
                               group=kwargs["group"])
        self.busy = True
    ...
    def request_complete(self, *args, **kwargs) -> None:
        ...
        self.send_global_event("system_request_completed",
                               group=kwargs["group"])
        self.busy = False
    ...
    def notify_new_request(self, *args, **kwargs) -> None:
        ...
        group = kwargs["group"]
        self.handle.publish(MQTTMessage(event="message_new_request", data={
            "group": group
        }))
    ...
    def notify_request_accepted(self, *args, **kwargs) -> None:
        ...
        group = kwargs["group"]
        self.handle.publish(MQTTMessage(event="message_request_accepted", data={
            "group": group
        }))
    ...
    def notify_request_completed(self, *args, **kwargs) -> None:
        ...
        group = kwargs["group"]
        self.handle.publish(MQTTMessage(event="message_request_completed", data={
            "group": group
        }))
